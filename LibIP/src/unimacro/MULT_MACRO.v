// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/MULT_MACRO.v,v 1.16 2012/05/22 18:37:21 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//Parameter checks 
    initial begin
     if (DEVICE == "VIRTEX5" || DEVICE == "VIRTEX6" || DEVICE == "SPARTAN6" || DEVICE == "7SERIES");
        ...
        begin
          $display("Attribute Syntax Error : The attribute DEVICE on ADDMACC_MACRO instance %m is set to %s.  Allowed values of this attribute are VIRTEX5, VIRTEX6, SPARTAN6, 7SERIES.", DEVICE);
          $finish;
        end
