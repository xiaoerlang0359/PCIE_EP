// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/fuji/X_PLLE2_ADV.v,v 1.25.40.3 2013/05/03 21:16:22 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
  ...
  always @(posedge pll_locked_tmp1)
    if (clkinsel_in === 0) begin
       ...
       if (period_avg > pchk_tmp1 || period_avg < pchk_tmp2) begin
         $display("Warning : input CLKIN2 period and attribute CLKIN2_PERIOD X_PLLE2_ADV instance %m are not same.");
         $finish;
       end
    end
    else begin
       ...
       if (period_avg > pchk_tmp1 || period_avg < pchk_tmp2) begin
         $display("Warning : input CLKIN1 period and attribute CLKIN1_PERIOD X_PLLE2_ADV instance %m are not same.");
         $finish;
       end
    end
  ...
  always @(posedge clkinstopped_out or posedge rst_in)
    if (rst_in)
     ...
     if (clkin_hold_f == 1) begin
       ...
       if (clkinsel_in == 1)
        $display(" Warning : input CLKIN1 of X_PLLE2_ADV on instance %m is stopped. Reset is required for X_PLLE2_ADV when input clock returns.");
       else
        $display(" Warning : input CLKIN2 of X_PLLE2_ADV on instance %m is stopped. Reset is required for X_PLLE2_ADV when input clock returns.");
     end
    end
