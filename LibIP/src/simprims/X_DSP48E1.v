...
// CR 619940 -- Enhanced DRC warning
              $display("DRC warning note : The simulation model does not know the placement of the X_DSP48E1 slices used, so it cannot fully confirm the above warning. It is necessary to view the placement of the X_DSP48E1 slices and ensure that these warnings are not being breached\n");
            end  
        end  
    end 
/*
