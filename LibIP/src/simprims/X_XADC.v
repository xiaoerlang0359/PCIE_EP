...
//  `endif  `ifdef XIL_TIMING
    ...
    case (SIM_DEVICE)
      ...
      "ZYNQ" : simd_f = 1;
      default : begin
        $display("Attribute Syntax Error : The Attribute SIM_DEVICE on X_XADC instance %m is set to %s.  Legal values for this attribute are 7SERIES, or ZYNQ.", SIM_DEVICE);
        $finish;
      end
    endcase
