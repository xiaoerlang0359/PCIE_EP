// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/blanc/X_MMCM_ADV.v,v 1.62.32.2 2013/05/03 21:16:22 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
module X_MMCM_ADV (
  ...
  real clkfb_div_frac, clk0_div_frac, clkvco_div_frac;
  ...
  always @(clkout_en0_tmp1 or clkout_en_t or clkout_en0_tmp )
    if (clkout_en0_tmp==0 )
     ...
     if (clkfb_frac_en == 1) begin 
       ...
       if (clkout_en_t == clkout_en_val && clkout_en0_tmp1 == 1)
          //clkout_en0 <= #(period_vco6 + period_vco) clkout_en0_tmp1;
          clkout_en0 <= #period_vco6 clkout_en0_tmp1;
     end 
   end
  ...
  always @(posedge clk0in) 
    if (clkout_en && clk0_frac_en) begin
          for (ik0=1; ik0 < 8; ik0=ik0+1) begin
               clk0_frac_out <= 1;
               #(clk0_frac_ht - 2);
               @(posedge clk0_sel_mux[0] or posedge clk0_sel_mux[1] or posedge clk0_sel_mux[2] or posedge clk0_sel_mux[3] or posedge clk0_sel_mux[4] or posedge clk0_sel_mux[5] or posedge clk0_sel_mux[6] or posedge clk0_sel_mux[7]);
               clk0_frac_out <= 0;
               #(clk0_frac_lt - 2);
               @(posedge clk0_sel_mux[0] or posedge clk0_sel_mux[1] or posedge clk0_sel_mux[2] or posedge clk0_sel_mux[3] or posedge clk0_sel_mux[4] or posedge clk0_sel_mux[5] or posedge clk0_sel_mux[6] or posedge clk0_sel_mux[7]);
          end
  ...
  always @(posedge clkfbm1in) 
    if (clkout_en && clkfb_frac_en) begin
        clkfbm1_frac_out <= 1;
          for (ib=1; ib < 8; ib=ib+1) begin
               #(clkfb_frac_ht - 2);
               @(posedge clkfb_sel_mux[0] or posedge clkfb_sel_mux[1] or posedge clkfb_sel_mux[2] or posedge clkfb_sel_mux[3] or posedge clkfb_sel_mux[4] or posedge clkfb_sel_mux[5] or posedge clkfb_sel_mux[6] or posedge clkfb_sel_mux[7]);
               clkfbm1_frac_out <= 0;
               #(clkfb_frac_lt - 2);
               @(posedge clkfb_sel_mux[0] or posedge clkfb_sel_mux[1] or posedge clkfb_sel_mux[2] or posedge clkfb_sel_mux[3] or posedge clkfb_sel_mux[4] or posedge clkfb_sel_mux[5] or posedge clkfb_sel_mux[6] or posedge clkfb_sel_mux[7]);
               clkfbm1_frac_out <= 1;
