...
module X_BUFIO2_2CLK (DIVCLK, IOCLK, SERDESSTROBE, I, IB);
  ...
  parameter integer DIVIDE = 3;        // {3..8}
...
//                end
            ...
            default : begin
                      $display("Attribute Syntax Error : The attribute DIVIDE on X_BUFIO2_2CLK instance %m is set to %d.  Legal values for this attribute are 3, 4, 5, 6, 7 or 8.", DIVIDE);
                      attr_err_flag = 1;
                      end
        endcase // (DIVIDE)
