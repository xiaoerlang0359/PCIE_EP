...
//  07/08/11 - CR616301 - Remove assign on RXUSRCLK
...
module X_GTXE2_CHANNEL (
  ...
  initial begin
    ...
    case (RXBUF_RESET_ON_EIDLE)
      ...
      default : begin
        $display("Attribute Syntax Error : The Attribute RXBUF_RESET_ON_EIDLE on X_GTXE2_CHANNEL instance %m is set to %s.  Legal values for this attribute are FALSE, or TRUE.", RXBUF_RESET_ON_EIDLE);
        $finish;
      end
    endcase
...
case (SIM_VERSION)
      ...
      default : begin
        $display("Attribute Syntax Error : The Attribute SIM_VERSION on X_GTXE2_CHANNEL instance %m is set to %s.  Legal values for this attribute are 4.0, 1.0, 1.1, 2.0, 3.0, 4.1, or 5.0.", SIM_VERSION);
        $finish;
      end
    endcase
  ...
  assign #(out_delay) GTXTXN = GTXTXN_OUT;
  assign #(out_delay) GTXTXP = GTXTXP_OUT;
  ...
  assign #(out_delay) RXMONITOROUT = RXMONITOROUT_OUT;
  ...
  assign #(in_delay) CLKRSVD_IN = CLKRSVD;
  ...
  assign #(in_delay) GTXRXN_IN = GTXRXN;
  assign #(in_delay) GTXRXP_IN = GTXRXP;
  assign #(in_delay) LOOPBACK_IN = LOOPBACK;
  assign #(in_delay) PCSRSVDIN_IN = PCSRSVDIN;
  assign #(in_delay) CSRSVDIN2_IN = PCSRSVDIN2;
  ...
  assign #(in_delay) RXDFEXYDHOLD_IN = RXDFEXYDHOLD;
  assign #(in_delay) RXDFEXYDOVRDEN_IN = RXDFEXYDOVRDEN;
