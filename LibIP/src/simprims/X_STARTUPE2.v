...
// Counters and Flags
  ...
  initial begin
    ...
    if ((SIM_CCLK_FREQ >= 0.0) && (SIM_CCLK_FREQ <= 10.0))
      ...
      $display("Attribute Syntax Error : The Attribute SIM_CCLK_FREQ on X_STARTUPE2 instance %m is set to %f.  Legal values for this attribute are  0.0 to 10.0.", SIM_CCLK_FREQ);
      $finish;
    end
