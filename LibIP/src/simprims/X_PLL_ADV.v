// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/rainier/X_PLL_ADV.v,v 1.73.62.1 2013/05/03 21:16:22 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//
  ...
  always @(posedge clkpll or posedge rst_in)
   ...
   if (clkout_en0_tmp==0)
        ...
        clkout_en0 <= #(clkin_period[0]) clkout_en0_tmp;
