...
//*** GLOBAL hidden GSR pin
	...
	case (AREG)
            0, 1, 2 : ;
            default : begin
	                  $display("Attribute Syntax Error : The attribute AREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0, 1 or 2.", AREG);
	                  $finish;
	              end
	endcase
	...
	case (AREG)
            0 : if(AREG != ACASCREG) begin
                    $display("Attribute Syntax Error : The attribute ACASCREG  on X_DSP48E instance %m is set to %d.  ACASCREG has to be set to 0 when attribute AREG = 0.", ACASCREG);
                    $finish;
                end
            1 : if(AREG != ACASCREG) begin
                    $display("Attribute Syntax Error : The attribute ACASCREG  on X_DSP48E instance %m is set to %d.  ACASCREG has to be set to 1 when attribute AREG = 1.", ACASCREG);
                    $finish;
                end
            2 : if((AREG != ACASCREG) && ((AREG-1) != ACASCREG)) begin
                    $display("Attribute Syntax Error : The attribute ACASCREG  on X_DSP48E instance %m is set to %d.  ACASCREG has to be set to either 2 or 1 when attribute AREG = 2.", ACASCREG);
                    $finish;
                end
            default : ;
	endcase
	...
	case (BREG)
            0, 1, 2 : ;
            default : begin
	                  $display("Attribute Syntax Error : The attribute BREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0, 1 or 2.", BREG);
	                  $finish;
	              end
	endcase
	...
	case (BREG)
            0 : if(BREG != BCASCREG) begin
                    $display("Attribute Syntax Error : The attribute BCASCREG  on X_DSP48E instance %m is set to %d.  BCASCREG has to be set to 0 when attribute BREG = 0.", BCASCREG);
                    $finish;
                end
            1 : if(BREG != BCASCREG) begin
                    $display("Attribute Syntax Error : The attribute BCASCREG  on X_DSP48E instance %m is set to %d.  BCASCREG has to be set to 1 when attribute BREG = 1.", BCASCREG);
                    $finish;
                end
            2 : if((BREG != BCASCREG) && ((BREG-1) != BCASCREG)) begin
                    $display("Attribute Syntax Error : The attribute BCASCREG  on X_DSP48E instance %m is set to %d.  BCASCREG has to be set to either 2 or 1 when attribute BREG = 2.", BCASCREG);
                    $finish;
                end
            default : ;
	endcase
        ...
        case (AUTORESET_PATTERN_DETECT)
            "TRUE", "FALSE" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute AUTORESET_PATTERN_DETECT on X_DSP48E instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.",  AUTORESET_PATTERN_DETECT);
               $finish;
            end
        endcase
        ...
        case (AUTORESET_PATTERN_DETECT_OPTINV)
            "MATCH", "NOT_MATCH" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute AUTORESET_PATTERN_DETECT_OPTINV on X_DSP48E instance %m is set to %s.  Legal values for this attribute are MATCH or NOT_MATCH.",  AUTORESET_PATTERN_DETECT_OPTINV);
               $finish;
            end
        endcase
        ...
        case (USE_MULT)
            ...
            "MULT" : if (MREG != 0) begin
                               $display("Attribute Syntax Error : The attribute USE_MULT on X_DSP48E instance %m is set to %s. This requires attribute MREG to be set to 0.", USE_MULT);
                               $finish;
                        end
            "MULT_S" : if (MREG != 1) begin
                               $display("Attribute Syntax Error : The attribute USE_MULT on X_DSP48E instance %m is set to %s. This requires attribute MREG to be set to 1.", USE_MULT);
                               $finish;
                        end
            default : begin
                          $display("Attribute Syntax Error : The attribute USE_MULT on X_DSP48E instance %m is set to %s. Legal values for this attribute are NONE, MULT or MULT_S.", USE_MULT);
                          $finish;
                      end
        endcase
        ...
        case (USE_PATTERN_DETECT)
            "PATDET", "NO_PATDET" : ;
            default : begin
               $display("Attribute Syntax Error : The attribute USE_PATTERN_DETECT on X_DSP48E instance %m is set to %s.  Legal values for this attribute are PATDET or NO_PATDET.",  USE_PATTERN_DETECT);
               $finish;
            end
        endcase
...
// CR 219407  --  (1)
    if((AUTORESET_PATTERN_DETECT == "TRUE") && (USE_PATTERN_DETECT == "NO_PATDET")) begin
         $display("Attribute Syntax Error : The attribute USE_PATTERN_DETECT on X_DSP48E instance %m must be set to PATDET in order to use AUTORESET_PATTERN_DETECT equals TRUE. Failure to do so could make timing reports inaccurate. ");
     end
...
//*********************************************************
	...
	case (A_INPUT)
            ...
            "CASCADE" : a_o_mux <= acin_in;
              default : begin
	       	            $display("Attribute Syntax Error : The attribute A_INPUT on X_DSP48E instance %m is set to %s.  Legal values for this attribute are DIRECT or CASCADE.", A_INPUT);
		            $finish;
                        end
	endcase
    end
...
//*********************************************************
	...
	case (B_INPUT)
            ...
            "CASCADE" : b_o_mux <= bcin_in;
              default : begin
	       	            $display("Attribute Syntax Error : The attribute B_INPUT on X_DSP48E instance %m is set to %s.  Legal values for this attribute are DIRECT or CASCADE.", B_INPUT);
		            $finish;
                        end
	endcase
    end
...
//*********************************************************
	...
	case (CREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CREG);
	                  $finish;
	              end
	endcase
    end
...
// Made mult_o to be "X"
    ...
    always @(qopmode_o_mux) begin
       if(qopmode_o_mux[3:0] == 4'b0101)
          if((USE_MULT == "NONE") || (USE_SIMD == "TWO24") || (USE_SIMD == "FOUR12")) 
               $display("OPMODE Input Warning : The OPMODE[3:0] %b to X_DSP48E instance %m is invalid when using attributes USE_MULT = NONE, or USE_SIMD = TWO24 or FOUR12 at %.3f ns.", qopmode_o_mux[3:0], $time/1000.0);
    end
	...
	case (MREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute MREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0 or 1.", MREG);
	                  $finish;
	              end
	endcase
    end
...
//*** CarryInSel and OpMode with 1 level of register
	...
	case (CARRYINSELREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINSELREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CARRYINSELREG);
	                  $finish;
	              end
	endcase
    end
...
// CR 619940 -- Enhanced DRC warning
              $display("DRC warning : CARRYCASCIN can only be used in the current X_DSP48E instance %m if the previous X_DSP48E is performing a two input ADD operation, or the current X_DSP48E is configured in the MAC extend opmode 7'b1001000 at %.3f ns. This warning can be also triggered if OPMODEREG is set to 1 and CARRYINSELREG is set to 0 - in which case please set CARRYINSELREG to 1.", $time/1000.0);
...
//CR 219047 (4) 
    always @(qcarryinsel_o_mux) begin
	  ...
	  $display("Attribute Syntax Warning : It is recommended that MREG and MULTCARRYINREG on X_DSP48E instance %m be set to the same value when using CARRYINSEL = 110 for multiply rounding.");
       end
    end
	...
	case (OPMODEREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute OPMODEREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0 or 1.", OPMODEREG);
	                  $finish;
	              end
	endcase
    end
...
//*** ALUMODE with 1 level of register
	...
	case (ALUMODEREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute ALUMODEREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0 or 1.", ALUMODEREG);
	                  $finish;
	              end
	endcase
    end
...
//------------------------------------------------------------------
	...
	begin
		...
		assign alu_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48E instance %m at %.3f ns requires attribute MREG set to 0.", qopmode_o_mux, qcarryinsel_o_mux, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign alu_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b with CARRYINSEL %b to X_DSP48E instance %m at %.3f ns requires attribute MREG set to 1.", qopmode_o_mux, qcarryinsel_o_mux, $time/1000.0);
	    end
	end
	...
	begin
		...
		assign qz_o_mux = 48'bx;
		assign alu_o = 48'bx;
		$display("OPMODE Input Warning : The OPMODE %b to X_DSP48E instance %m at %.3f ns requires attribute PREG set to 1.", qopmode_o_mux, $time/1000.0);
	    end
	end
             ...
             case (qopmode_o_mux)
              ...
              default : begin
                 if (invalid_opmode) begin
                    ...
                    assign qz_o_mux = 48'bx;
                    assign alu_o    = 48'bx;
                    $display("OPMODE Input Warning : The OPMODE %b to X_DSP48E instance %m is invalid for LOGIC MODES at %.3f ns.", qopmode_o_mux, $time/1000.0);
           ...
           casex ({qopmode_o_mux[3:2], qalumode_o_mux})
              ...
              6'bXX0000 : begin
		        ...
		        alu_qrt4_tmp = qz_o_mux[((4*MAX_ALU_QUART)-1):(3*MAX_ALU_QUART)] + 
                    ...
                    default : begin
                        $display("Attribute Syntax Error : The attribute USE_SIMD on X_DSP48E instance %m is set to %s. Legal values for this attribute are  ONE48 or TWO24 or FOUR12.", USE_SIMD);
                        $finish;
                    end
                 endcase
              end
...
//-------  input 0
	...
	case (CARRYINREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute CARRYINREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0 or 1.", CARRYINREG);
	                  $finish;
	              end
	endcase
    end
...
//-------  input 7
	...
	case (MULTCARRYINREG)
            ...
            default : begin
	                  $display("Attribute Syntax Error : The attribute MULTCARRYINREG on X_DSP48E instance %m is set to %d.  Legal values for this attribute are 0 or 1.", MULTCARRYINREG);
	                  $finish;
	              end
	endcase
    end
    ...
    always @(alu_o, qc_o_mux, negedge gsr_in) begin
        ...
        case(SEL_PATTERN)
           ...
           "C"       : pattern_qp <= qc_o_mux;
            default : begin
                         $display("Attribute Syntax Error : The attribute SEL_PATTERN on X_DSP48E instance %m is set to %s.  Legal values for this attribute are PATTERN or C.", SEL_PATTERN);
                         $finish;
                      end
	endcase
        ...
        case(SEL_ROUNDING_MASK)
           "SEL_MASK" : 
               case(SEL_MASK)
                  ...
                  "C"    : mask_qp <= qc_o_mux;
                   default : begin
                                $display("Attribute Syntax Error : The attribute SEL_MASK on X_DSP48E instance %m is set to %s.  Legal values for this attribute are MASK or C.", SEL_MASK);
                                $finish;
                             end
       	       endcase
           ...
           "MODE2" :  mask_qp     <=   ~qc_o_mux << 2;
            default : begin
                         $display("Attribute Syntax Error : The attribute SEL_ROUNDING_MASK on X_DSP48E instance %m is set to %s.  Legal values for this attribute are SEL_MASK or MODE1 or MODE2.", SEL_ROUNDING_MASK);
                         $finish;
                      end
        endcase
...
//*** Timing Checks Start here
	...
	$setuphold (posedge CLK, posedge CEMULTCARRYIN, 0:0:0, 0:0:0, notifier, , , clk_in, cemultcarryin_in);
	$setuphold (posedge CLK, negedge CEMULTCARRYIN, 0:0:0, 0:0:0, notifier, , , clk_in, cemultcarryin_in);
