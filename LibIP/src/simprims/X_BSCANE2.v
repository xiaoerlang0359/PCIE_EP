...
//--####################################################################
    initial begin
        ...
        if ((DISABLE_JTAG != "TRUE") && (DISABLE_JTAG != "FALSE")) begin
            $display("Attribute Syntax Error : The attribute DISABLE_JTAG on X_BSCANE2 instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", DISABLE_JTAG);
            $finish;
        end
        ...
        if ((JTAG_CHAIN != 1) && (JTAG_CHAIN != 2) && (JTAG_CHAIN != 3) && (JTAG_CHAIN != 4)) begin
            $display("Attribute Syntax Error : The attribute JTAG_CHAIN on X_BSCANE2 instance %m is set to %d.  Legal values for this attribute are 1, 2, 3 or 4.", JTAG_CHAIN);
            $finish;
        end
