// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/fuji/X_BUFR.v,v 1.7 2012/03/15 20:03:18 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
module X_BUFR (O, CE, CLR, I);
	...
	case (BUFR_DIVIDE)
	    ...
	    default : begin 
		          $display("Attribute Syntax Error : The attribute BUFR_DIVIDE on X_BUFR instance %m is set to %s.  Legal values for this attribute are BYPASS, 1, 2, 3, 4, 5, 6, 7 or 8.", BUFR_DIVIDE);
	                  $finish;
	    end
	endcase // case(BUFR_DIVIDE)
        ...
        case (SIM_DEVICE)
           ...
           "7SERIES" : ;
	    default : begin 
		          $display("Attribute Syntax Error : The attribute SIM_DEVICE on X_BUFR instance %m is set to %s.  Legal values for this attribute are VIRTEX4 or VIRTEX5 or VIRTEX6 or 7SERIES.", SIM_DEVICE);
	                  $finish;
	    end
        endcase 
