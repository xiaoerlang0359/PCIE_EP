...
//                       rd_data_cnt <= {pack_in_reg[4:0], 1'b0};
   ...
   always @(posedge startup_set or posedge desynch_set or negedge  rw_en )
    ...
    always @(posedge rdwr_b_in or negedge rst_intl or posedge abort_flag_rst or posedge csi_b_in) begin
	if (rst_intl==0 || abort_flag_rst==1 || csi_b_in == 1)
		...
		abort_flag_wr <= 0;
    end // always @ (posedge cclk_in or negedge rst_intl or posedge abort_flag_rst)
    

    always @(negedge rdwr_b_in or negedge rst_intl or posedge abort_flag_rst or posedge csi_b_in) begin	
