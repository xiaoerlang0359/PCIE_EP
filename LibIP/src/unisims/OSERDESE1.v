...
//    12/21/11 - CR 635727 Removed 1 ps glitch from oq_out/tq_out due to vcs
...
// 1 ps glitch remover 
localparam      OnePsGlitchRemover = 2;
...
tout_oserdese1_vlog trio (.data1(tmux1), .data2(tmux2),
      ...
      assign OFB         = ofb_out;
      assign #OnePsGlitchRemover OQ = oq_out;
      assign SHIFTOUT1   = shiftout1_out;
      assign SHIFTOUT2   = shiftout2_out;
      assign TFB         = tfb_out;
      assign #OnePsGlitchRemover TQ = tq_out;
