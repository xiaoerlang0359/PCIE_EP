   ...
   always @(adc_state or next_state or curr_chan  or mn_mux_in or curr_b_u) begin
	...
	if ((adc_state == S3_ST && next_state == S5_ST) ||  adc_state == S5_ST) begin
	    if (curr_chan == 0) begin    // temperature conversion
            ...
            end // if (curr_chan == 3 || (curr_chan >=16 && curr_chan <= 31))
            else begin
                conv_result_int = 0;
            end
	end 
...
//    assign eoc_out_t = eoc_out | eoc_out2;
	...
	if (rst_in_not_seq == 1) begin
		...
		if (eoc_out2 == 1) begin
			...
			end // else: !if(curr_pj_set2 == 2'b00)
		    end // if (curr_chan_lat2 == 5'b01111)
		end // if (eoc_out2 == 1)
	    end // if ( rst_lock == 0)
    end // always @ (posedge eoc_out_t or posedge rst_in_not_seq)
