// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/stan/RAMB8BWER.v,v 1.24 2011/08/04 18:29:25 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
module RAMB8BWER (DOADO, DOBDO, DOPADOP, DOPBDOP, 
	...
	case (RAM_MODE)
	    ...
	    "SDP" : begin
			    ...
			    $display("DRC Error : Both attributes WRITE_MODE_A and WRITE_MODE_B must be set to READ_FIRST or both attributes must be set to WRITE_FIRST when RAM_MODE = SDP on RAMB8BWER instance %m.");
			    finish_error = 1;
			end
