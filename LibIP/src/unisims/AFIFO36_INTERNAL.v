// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/rainier/AFIFO36_INTERNAL.v,v 1.23 2010/12/09 01:01:21 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
/********************* SAFE mode **************************/
	...
	if (rst_in === 1'b0) begin
		...
		if (ALMOST_EMPTY_OFFSET <= (4 * roundup_int_period_rdclk_wrclk)) begin
		    ...
		    $display("DRC Error : The attribute ALMOST_EMPTY_OFFSET on AFIFO36_INTERNAL instance %m is set to %d. It must be set to a value greater than (4 * roundup (WRCLK frequency / RDCLK frequency)) when AFIFO36_INTERNAL is configured in FIRST_WORD_FALL_THROUGH mode.", ALMOST_EMPTY_OFFSET);
		    $finish;
